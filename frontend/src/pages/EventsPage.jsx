    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto p-6">
          ...
          {events.length > 0 && <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
             {events.map((event) => {
        ...
        {events.length === 0 &&<div className="py-20 text-center">
            ...
            <h3 className="text-gray-900 font-semibold">No events yet</h3>
            <p className="mt-1 text-gray-500 text-sm">Check back later for upcoming events!</p>
          </div>}
