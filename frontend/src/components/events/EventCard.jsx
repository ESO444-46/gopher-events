...
const EventCard = ({ title, venue, startsAt, endsAt, imageUrl }) => {
  ...
  return (
    <div className="group bg-paper rounded-2xl border border-line overflow-hidden shadow-sm hover:shadow-lg hover:border-maroon/20 hover:-translate-y-0.5 transition-all duration-300">
      ...
      <div className="p-5 space-y-4">
        <h3 className="font-display font-semibold text-maroon text-base leading-snug line-clamp-2 min-h-[2.75rem]">{title}</h3>

        <div className="space-y-2.5">
          <div className="flex items-center gap-2.5 text-sm text-ink-soft">
            <svg className="h-4 w-4 text-ink-soft flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center gap-2.5 text-sm text-ink-soft font-mono">
            <svg className="h-4 w-4 text-ink-soft flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
